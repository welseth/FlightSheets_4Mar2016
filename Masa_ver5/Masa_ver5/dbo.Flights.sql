CREATE TABLE [dbo].[Flights] (
    [Flight_refnum]          INT   IDENTITY (0, 1) NOT NULL,
    ...
    [TowPlane2]              INT   NULL,
    [Date]                   DATE  NULL,
    [Glider_takeoff_time]    DATETIMEOFFSET   NULL,
    [Glider_landing_time]    DATETIMEOFFSET   NULL,
    [Tow_takeoff_time]       TIME   NULL,
    [Tow_landing_time]       TIME   NULL,
    ...
    [Split_cost]             BIT   NULL,
    [Percent_1st_check]      INT   NULL,
    [Second_name_on_invoice] INT   NULL,
    [Penalty_charge]         BIT   NULL,
    [Cost_this_flight]       MONEY NULL,
    PRIMARY KEY CLUSTERED ([Flight_refnum] ASC),
    CONSTRAINT [FK_Flights_Glider] FOREIGN KEY ([Glider]) REFERENCES [dbo].[Aircraft] ([Aircraft_refnum]),
    ...
    CONSTRAINT [FK_Passenger_name] FOREIGN KEY ([Passenger_name]) REFERENCES [dbo].[Members] ([Member_refnum]),
